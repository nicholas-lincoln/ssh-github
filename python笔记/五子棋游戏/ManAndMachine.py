...
SCREEN_HEIGHT = SIZE * (Line_Points - 1) + Outer_Width * 2 + Border_Width + Inside_Width * 2  # 游戏屏幕的高度
SCREEN_WIDTH = SCREEN_HEIGHT + 200  # 游戏屏幕的宽度
            ...
            if event.type == QUIT:
                ...
                if winner is None:
                    ...
                    if pressed_array[0]:
                        ...
                        click_point = _get_click_point(mouse_pos)
...
def _draw_left_info(screen, font, cur_runner, black_win_count, white_win_count):
    ...
    _draw_chessman_pos(screen, (SCREEN_HEIGHT + Stone_Radius2, SCREEN_HEIGHT - int(Stone_Radius2 * 2)),
...
def _get_click_point(click_pos):
